...
import { getContratos, getContrato, createContrato, updateContrato, deleteContrato, finalizarContrato, renovarContrato, getFacturasContrato } from '../controllers/contratosController.js';
...
router.get('/:id', requireRoles('ADMIN', 'AGENTE'), getContrato);
